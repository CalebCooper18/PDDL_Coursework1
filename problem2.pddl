;plan scans two plans and nebula and adds it to mission control
...
(:goal 
(and
    (plasma_info jik centralcomputer)
    (planet_info_air mars centralcomputer)
    (planet_info_air saturn centralcomputer)
